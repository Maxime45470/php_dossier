    ...
    <header>
        ...
        <div id="profil" class="d-flex">
            ...
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <img id="logo" src="assets\img\yourLogo.webp" alt="">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-actualites" role="tabpanel"
                    ...
                    <h1>Actualitées</h1>
                   <?php require_once('gestion-actus.php'); ?>
                ...
                <div class="tab-pane fade" id="v-pills-utilisateur" role="tabpanel"
                    ...
                    <?php require_once('gestion-users.php'); ?>
                </div>
            ...
            <div class="btn-group">
                ...
                <img id="imgPrf" src="assets\img\profil.webp" alt="profil">
