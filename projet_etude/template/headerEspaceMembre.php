...
<head>
    ...
    <title>AA Sonorisation / Eclairage</title>
</head>
<body>
    <header>
        <div class="logo"><a href="../index.php"> <img src="../assets/logo/logoAA.png" alt="logo"></a></div>
        <nav>
            <div class="nonBurger">
                <ul class="nav">
                    ...
                    <li><a href="hifi.php">HIFI & Vidéo</a></li>
                    <li><a href="sono.php">Sono portable</a></li>
            ...
            <div class="burger">
                <div id="mySidenav" class="sidenav">
                    ...
                    <ul>
                        <li><a href="../index.php">Accueil</a></li>
                        <li><a class="active" href="espaceMembre.php">Mon espace</a></li>
                        <li><a href="eclairage.php">Eclairage</a></li>
                        <li><a href="hifi.php">HIFI & Vidéo</a></li>
                        <li><a href="sono.php">Sono portable</a></li>
                        <li><a href="contact.php">Contact</a></li>
