...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/hifi_video.css">
    <title>E-commerce AV</title>
</head>
<div class="container">
<header class="header">
    <div class=logo>
    ...
    <nav class="navbar">
        <ul class="nav_item_group">
            <li><a href="#">eclairage</a></li>
            <li><a href="#">hifi & video</a></li>
            <li><a href="#">sono portable</a></li>
